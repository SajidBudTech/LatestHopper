...
class AuthRepository extends HttpService {
  ...
  Future<DialogData> register({
    ...
    final Map<String, dynamic> bodyPayload =
    {
      ...
      "height": height,
      "weight": wieght,
      "health_issues_data": healthIssue,
  ...
  Future<DialogData> resetPassword({
    ...
    if (apiResponse.allGood) {
      ...
      resultDialogData.body = apiResponse.body['successMessage'];
      resultDialogData.dialogType = DialogType.success;
    } else {
  ...
  //save user data
  void saveuserData(dynamic userObject, String token, String password) async {
    ...
    AuthBloc.saveUserData(userObject, token,password);
  ...
  Future<DialogData> sendEmail({
    ...
    final apiResult = await dio.post("https://api.emailjs.com/api/v1.0/email/send",
      data:{
