...
class CustomCommentTextFormField extends StatefulWidget {
  CustomCommentTextFormField({
    Key key,
    this.hintText,
    this.border,
    this.filled,
  ...
  @override
  _CustomCommentTextFormFieldState createState() => _CustomCommentTextFormFieldState();
}

class _CustomCommentTextFormFieldState extends State<CustomCommentTextFormField> {
            ...
            children: <Widget>[
              ...
              Expanded(
                child: TextFormField(
                  ...
                  maxLines: widget.multiLine?20:null,
